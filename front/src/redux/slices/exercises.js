...
export const fetchRemoveExercises = createAsyncThunk(
 "exercises/fetchRemoveExercises",
 async (id) => await axios.delete(`/exercises/${id}`)
);
...
const exerciseSlice = createSlice({
 ...
 extraReducers: {
  ...
  [fetchRemoveExercises.pending]: (state, action) => {
   state.exercises.items = state.exercises.items.filter(
